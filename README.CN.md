...
对于中国大陆的开发者，GitHub可能存在DNS污染，因此访问速度较慢。因此对于本项目Clone时可采用三种替代方案：
...
同时，音频的格式也有待进一步压缩转码，这会在近期1.0版本正式上线后进行。
